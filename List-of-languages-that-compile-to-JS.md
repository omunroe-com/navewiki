...
| [Moescript](https://github.com/tcdona/moescript) | Indent-based language. The original repository at https://github.com/moescript/moescript is missing. The link is to a surviving fork. |
...
| [Ć Programming Language](http://cito.sourceforge.net/) | Automatically translated to C, Java, C#, JavaScript, ActionScript, Perl and D. |
