...
*Coffeescript's syntax is big on reducing the size of function declarations, as evidenced by the replacing of the `function` keyword with the much shorted `->` glyph. Take this into consideration if you plan to propose anything around this declaration syntax.*
...
```coffeescript
bind = (fn, cxt, args...) -> -> fn.apply cxt, args.concat arguments
```
